    ...
    <>
        ...
        <div className="about-layout">
          <div>
            <div className="sec-header">
              ...
              <h2>Unis par nos racines, tournés vers l&apos;avenir</h2>
            </div>
      ...
      <section id="events" className="section-events">
        <div className="events-container">
          <div className="sec-header center">
            ...
            <h2>Des moments qui rassemblent</h2>
            <p>Culture, partage et bonne ambiance — voici ce qui nous anime.</p>
          </div>
      ...
      <section id="resources" className="section-resources">
        <div className="resources-container">
          <div className="sec-header center">
            ...
            <h2>Tout pour bien s&apos;installer</h2>
            <p>Les ressources essentielles pour réussir ta transition vers la vie à Québec.</p>
          </div>
      ...
      <section id="contact" className="section-contact">
        ...
        <div className="cta-inner">
          <h2>Fais partie de la famille</h2>
          <p>Que tu sois ivoirien ou simplement curieux de notre culture, tu es le bienvenu. Akwaba !</p>
